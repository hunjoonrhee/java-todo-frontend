...
export default function ToDoCard (props: ToDoCardProps){
    ...
    return(
        <div className={"card"}>
            ...
            <div className={"todo-name-status"}>
                <h5 className={"todo"} id={props.ToDoCard.id}>{props.ToDoCard.description}</h5>
            </div>
            <div className={"btns"}>
                <Link to={"/"+ props.ToDoCard.id}>
                    <input className={"btn"} type={"submit"} value={"Edit"}/>
                </Link>
                <form >
                    <input className={"btn"} type={"submit"} value={"Advance"}/>
                </form>
            </div>
